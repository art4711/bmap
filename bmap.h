...
int bmap_inter64_count_r(struct bmap * __restrict r, struct bmap * __restrict s);
...
int bmap_inter64_avx_a_count_r(struct bmap * __restrict r, struct bmap * __restrict s);
